...
# # Modify the OPTICS section in cluster_module to remove zero clusters
# cat("\nOPTICS:\n")
# cluster_result <- cluster_module(distance_matrix, algo = 'OPTICS', minPts = 5, xi = 0.05)
# 
# # Remove zero clusters from OPTICS results if they exist
# if (any(cluster_result == 0)) {
#     cluster_result <- cluster_result[cluster_result != 0]
#     cat("Zero clusters removed.\n")
# }
...
Log transform - outlier
summary statiscal summary of different clusters
penalties 
